...
const KissDay: React.FC<{ data: DayContent, isLocked?: boolean }> = ({ data, isLocked }) => {
  const { userId } = useParams<{ userId: string }>();

  if (isLocked) {
    return <WaitingPage
      partnerName=""
      customTitle="Kiss Day Loading... 💋"
      customMessage="Apne honth tayar rakho... Virtual kisses on the way! 😉"
    />;
  }
