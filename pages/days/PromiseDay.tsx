...
const PromiseDay: React.FC<{ data: DayContent, isLocked?: boolean }> = ({ data, isLocked }) => {
  const { userId } = useParams<{ userId: string }>();

  if (isLocked) {
    return <WaitingPage
      partnerName=""
      customTitle="Promise Day Loading... 🤝"
      customMessage="Wade karne ka waqt aane wala hai... Taiyaar ho? ⏳"
    />;
  }
