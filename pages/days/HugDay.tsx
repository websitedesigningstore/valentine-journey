...
const HugDay: React.FC<{ data: DayContent, isLocked?: boolean }> = ({ data, isLocked }) => {
  const { userId } = useParams<{ userId: string }>();

  if (isLocked) {
    return <WaitingPage
      partnerName=""
      customTitle="Hug Day Loading... 🤗"
      customMessage="Bahein faila kar intezaar karo... Ek jadu ki jhappi aa rahi hai! ⏳"
    />;
  }
