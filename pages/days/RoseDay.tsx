...
const RoseDay: React.FC<{ data: DayContent; partnerName: string }> = ({ data, partnerName }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 overflow-hidden relative bg-rose-50">
      <FloatingHearts />
      ...
      {(stage === 'scratch' || stage === 'reveal_message' || stage === 'ask_permission') && (
        <div className="text-center mb-6 z-10 animate-fade-in-up absolute top-10">
          ...
          <p className="text-gray-500 text-sm mt-2 font-medium">Step by step pyaar ka izhaar...</p>
        </div>
      )}
